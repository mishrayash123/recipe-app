...
const Recipes = (props) => {
    ...
    return (
        ...
        <h2 className="text-white font-serif text-9xl text-center my-20 mb-20">😔</h2>
        
    </div>  :
        <div className="row mt-4 mx-2 mb-5 w-75 mx-auto">
            {
            recipes.map(recipe => (
    ...
    <div className="bg-white/25 border border-light border  border-opacity-10 mt-5" >
