    ...
    return (
        <div className="mt-36">
            <form onSubmit={forgetpassword}
                className="mx-auto w-50 mt-5  bg-gradient-to-r from-zinc-900 via-pink-900 to-zinc-900 dark:bg-white/10  border border-dark border border-3 border-opacity-10 rounded ">
