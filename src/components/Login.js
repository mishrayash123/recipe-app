...
export default function Login() {
    ...
    return (
        <div className="mt-36">
            ...
            <form onSubmit={login}
                className="mx-auto w-50 mt-5 bg-white/10  border border-light border border-3 border-opacity-10 rounded mb-32">
    ...
    <div className="bg-white/25 border border-light border  border-opacity-10 fixed-bottom" >
